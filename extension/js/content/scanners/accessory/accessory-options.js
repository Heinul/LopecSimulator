...
LopecScanner.Scanners.Accessory.Options = (function() {
  ...
  let accessoryOptions = {
    ...
    DEALER: {
      ...
      NECKLACE: [
        { value: "addDamagePer", description: "추가 피해" }, // 추가 피해
        { value: "finalDamagePer", description: "적에게 주는 피해 증가" }, // 적에게 주는 피해 증가
        { value: "value", description: "없음" } // 없음 옵션
      ],
      // 귀걸이 옵션
      EARRING: [
        { value: "atkPer", description: "공격력 %" }, // 공격력 %
        { value: "weaponAtkPer", description: "무기 공격력 %" }, // 무기 공격력 %
        { value: "value", description: "없음" } // 없음 옵션
      ],
      // 반지 옵션
      RING: [
        { value: "criticalDamagePer", description: "치명타 피해" }, // 치명타 피해
        { value: "criticalChancePer", description: "치명타 적중률" }, // 치명타 적중률
        { value: "value", description: "없음" } // 없음 옵션
      ]
    },
    ...
    SUPPORTER: {
      // 목걸이 옵션
      NECKLACE: [
        { value: "stigmaPer", description: "낙인력" }, // 낙인력
        { value: "value", description: "세레나데, 신앙, 조화 게이지 획득량" }, // 세레나데/신성/조화 게이지 획득량 증가
        { value: "value", description: "없음" } // 없음 옵션
      ],
      // 귀걸이 옵션
      EARRING: [
        { value: "weaponAtkPer", description: "무기 공격력 %" }, // 무기 공격력 %
        { value: "weaponAtkPlus", description: "무기 공격력 +" }, // 무기 공격력 +
        { value: "value", description: "없음" } // 없음 옵션
      ],
      // 반지 옵션
      RING: [
        { value: "atkBuff", description: "아군 공격력 강화 효과" }, // 아군 공격력 강화 효과
        { value: "damageBuff", description: "아군 피해량 강화 효과" }, // 아군 피해량 강화 효과
        { value: "value", description: "없음" } // 없음 옵션
      ]
    },
